            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm a Software Engineer based in India. 
                    ...
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/harshk9155" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
                    Need something built or simply want to have chat? Reach out to me on
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://www.instagram.com/harshk9155/" color="inherit" target="_blank">
                            <Instagram />
                        </Link>
                    </Box>  
                        or send me an Email 
                        <Link href="mailto:harshk9155@gmail.com?Subject=This is a subject" target="_blank" color="inherit">
                            <Email />
                        </Link>.
                </Text>
            </Wrapper>
